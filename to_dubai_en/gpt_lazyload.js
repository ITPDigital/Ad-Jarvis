...
function constructCatfish(elem, event) {
    ...
    var popOutWrap = document.querySelector('.catfish_block .popWrapper');
	document.querySelector(".catfish_block .popClose").classList.add("show-close");
	document.querySelector(".catfish_block .popClose").style.display = 'block';
...
function constructOverlay(elem, event) {
	...
	document.querySelector(".overlay_block .popClose").classList.add("show-close");
	document.querySelector(".overlay_block .popClose").style.display = 'block';
    var popOutWrap = document.querySelector('.overlay_block .popWrapper');
    popOutWrap.style.width = event.size[0] + 'px';
    popOutWrap.style.height = event.size[1] + 'px';
   /* popOutWrap.style.marginLeft = '-' + (event.size[0] / 2) + 'px';
