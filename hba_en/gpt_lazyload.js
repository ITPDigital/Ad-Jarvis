            ...
            googletag.pubads().addEventListener('slotRenderEnded', function(event) {
                ...
                if (event.isEmpty) {
                    ...
                    if (renderedAdType == "banner450x450") { //overlay ad
						...
						if(jQuery('[data-adtype="banner300x250"]').hasClass("ad-home")) {//for home page
							jQuery('[data-adtype="banner300x250"]').parent().parent().remove();
						}
                    ...
                    if (renderedAdType == "banner970x250") { //BB block
                        if (enableStickyAds && !isBBSlotViewed) {
                            ...
                            jQuery(window).scroll(function() { //sticky bb if ad is not viewed for bbViewTime
								...
								var offsetTop = $(window).width() <= 600 ? 0 : 0;
						...
						/*if(jQuery('[data-adtype="banner300x250"]').hasClass("comb-ad")) {//not for home page
...
function calculateVisibilityForDiv(slotIndex, div$, gptAdtype) {
	...
	var divPosition = 0;
	if(jQuery("#ad-slot-" + slotIndex)) {
		jQuery("#ad-slot-" + slotIndex).offset().top;
	}
